...
//            if (null == le)
//            {
//                Debug.LogWarning(this + " : impossible de trouver LayoutElement");
//                return;
//            }
//            else
//            {
...
//            if (null == g)
//            {
//                Debug.LogWarning(this + " : impossible de trouver le gameobject ZoomButton");
//                return;
//            }
//            else
//            {
...
//                {
//                    Debug.LogWarning(this + " : le gameobject ZoomButton is not under the DataDiagram");//ééééééééééééééééééééééééééééé
//                    return;
//                }
//                else
//                {
...
//                    if (null == m_ZoomButton)
//                    {
//                        Debug.LogWarning(this + " : impossible de trouver le gameobject DD_ZoomButton");
//                        return;
//                    }
//                    else
//                    {
