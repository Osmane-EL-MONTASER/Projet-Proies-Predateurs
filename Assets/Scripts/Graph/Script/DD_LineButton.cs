...
/// elle permet de gérer les évenements liés aux boutons pour les courbes et la fenêtre.
...
public class DD_LineButton : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    /// </summary>
    /// <param name="lines"> Les courbes sur le graphe. </param>
    ...
    /// <summary>
    /// Méthode qui permet de supprimer un label s'il n'existe plus.
    /// </summary>
